...
def create_schema(schema):
    ...
    schema_sql = f"CREATE SCHEMA IF NOT EXISTS {schema};" # SQL statement to create a schema if it does not already exist
...
def get_video_ids(cur, schema):
    cur.execute(f"""SELECT "Video_ID" FROM {schema}.{table};""") # Execute a SQL query to select all video IDs from the specified schema and table
